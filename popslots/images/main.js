$(document).ready(function() {	
	...
	$('#increase-Chips').click(function() {
		...
		sliderChips.slider( "value", sliderCurrentChipsValue + 15000 );
	});
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() {
					...
					$('#instructions-completion-indicator-step-3').addClass('step-pending').html( "<i class='fa fa-repeat fa-Chips' aria-hidden='true'></i>" );
					if ($(window).width() < 600) {
